...
posts.post('/posts',async (req,res)=>{
    ...
    const {post_type, post_description, video, love_index_id, image_id, user_id} = req.body;
    const sql = 'INSERT INTO onelove.posts (post_type, post_description, video, love_index_id, image_id, user_id) VALUES (?, ?, ?, ?, ?, ?)';
    const values = [post_type, post_description, video, love_index_id, image_id, user_id];
